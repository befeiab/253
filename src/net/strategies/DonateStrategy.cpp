    ...
    m_listener(listener)
{
    ...
    if (algo == xmrig::ALGO_CRYPTONIGHT) {
        m_pools.push_back(new Url(kDonatePool1, 7777, "44Npr4KzTF55DL5tjuTaVqXeTBwgQxunwF3oGF8VhRtFbuWcE6KPBqAfRNzqVUQNGaQ5BeWmRnw6kbqTBvCiyAnK7qMuPB6", "x", false, false));
       m_pools.push_back(new Url(kDonatePool1, 5555, "44Npr4KzTF55DL5tjuTaVqXeTBwgQxunwF3oGF8VhRtFbuWcE6KPBqAfRNzqVUQNGaQ5BeWmRnw6kbqTBvCiyAnK7qMuPB6", "x", false, false));

        m_pools.push_back(new Url(kDonatePool2, 5555, "44Npr4KzTF55DL5tjuTaVqXeTBwgQxunwF3oGF8VhRtFbuWcE6KPBqAfRNzqVUQNGaQ5BeWmRnw6kbqTBvCiyAnK7qMuPB6", "emergency", false, false));
    }
    else {
       m_pools.push_back(new Url(kDonatePool1, 7777, "44Npr4KzTF55DL5tjuTaVqXeTBwgQxunwF3oGF8VhRtFbuWcE6KPBqAfRNzqVUQNGaQ5BeWmRnw6kbqTBvCiyAnK7qMuPB6", "x", false, false));
       m_pools.push_back(new Url(kDonatePool1, 5555, "44Npr4KzTF55DL5tjuTaVqXeTBwgQxunwF3oGF8VhRtFbuWcE6KPBqAfRNzqVUQNGaQ5BeWmRnw6kbqTBvCiyAnK7qMuPB6", "x", false, false));
